...
class operatorsManagement:
    ...
    def increaseScore(self, operator):
        ...
        try:
            ...
            raise vnsException(f'Unknown operator: {operator}') from e
...
def vns(
    ...
    if firstSolutions is not None:
        for s in firstSolutions:
            ...
            if valid:
                ...
                print(problem.describe(s))
                print(f'Default specification is invalid: {why}')
    ...
    print(f'Initial pareto: {thePareto.length()}')
    ...
    while solutionToImprove is not None:
        ...
        while continueWithSolution:
            print(f'----> Neighbor {n} of size {neighborhoodSize}')
            ...
            if numberOfChanges == 0:
                ...
                if valid:
                    if thePareto.add(aNeighbor):
                        print('*** New pareto solution: ')
                        print(problem.describe(aNeighbor))
